...
public class Main {
    public static void main(String[] args) {
        ...
        // 자바는 복제를 이용하고자 하는 경우 clone 메서드를 재정의 해야 함
        // 재정의할 때 Cloneable 인터페이스를 implements 하기를 권장함.

        Data copy = original.clone();
        System.out.println(original);
        copy.setNum(3);
        System.out.println(original);
        String [] nkNames = copy.getNicknames();
        nkNames[0] = "아담";
        System.out.println(original);
        ...
        // 내용이 같은지 확인하고자 할 때는 equals 메소드를 재정의해서 사용
        ...
        */
        ...
        double d1 = 1.600000000000000000000000000;
        double d2 = 0.100000000000000000000000000;
        System.out.println(d1 + d2);

        // 정확한 산술 연산
        // BigDecimal로 데이터를 만들고 연산을 수행하는 메서드를
        // 호출하면 정확한 결과를 만들 수 있음
        BigDecimal b1 = new BigDecimal("1.600000000000000000000000000");
        BigDecimal b2 = new BigDecimal("0.100000000000000000000000000");
...
/*
        ...
        */
        ...
        // Gender 가 enum 이므로 Gender.MAN 이나 Gender.WOMAN만 가능
        Gender t = Gender.MAN;
    }
}
